...
const TAROT_DECK = [
  {
    ...
    keywords: { zh: ["归零", "直觉", "混沌", "跃迁"], en: ["Zero", "Intuition", "Chaos", "Leap"] },
    meaning: { zh: "一切的开始，也是一切的结束。你是傻瓜，也是智者。", en: "The beginning and the end. You are the fool, and the sage." },
    reactions: {
  ...
  },
  {
    ...
    keywords: { zh: ["创造", "能力", "显化", "欺诈"], en: ["Creation", "Skill", "Manifest", "Trickery"] },
    meaning: { zh: "你拥有所有的工具。现在，把想法变成现实。", en: "You have all the tools. Now, turn your ideas into reality." },
    reactions: {
  ...
  },
  {
    ...
    keywords: { zh: ["直觉", "潜意识", "秘密", "静默"], en: ["Intuition", "Subconscious", "Secret", "Silence"] },
    meaning: { zh: "相信你的直觉。答案不在外面，在你的潜意识里。", en: "Trust your intuition. The answer lies in your subconscious." },
    reactions: {
  ...
  },
  {
    ...
    keywords: { zh: ["丰饶", "感官", "孕育", "自然"], en: ["Fertility", "Senses", "Nurture", "Nature"] },
    meaning: { zh: "去感受生命，去爱，去创造。世界是你的花园。", en: "Feel life, love, and create. The world is your garden." },
    reactions: {
  ...
  },
  {
    ...
    keywords: { zh: ["秩序", "控制", "权威", "结构"], en: ["Order", "Control", "Authority", "Structure"] },
    meaning: { zh: "建立你的帝国。有时候，你需要的是铁腕。", en: "Build your empire. Sometimes, you need an iron fist." },
    reactions: {
  ...
  },
  {
    ...
    keywords: { zh: ["传统", "信仰", "指导", "从众"], en: ["Tradition", "Belief", "Guide", "Conformity"] },
    meaning: { zh: "在这个阶段，你需要遵循已有的智慧和规则。", en: "Follow the established wisdom and rules for now." },
    reactions: {
  ...
  },
  {
    ...
    keywords: { zh: ["选择", "结合", "价值观", "诱惑"], en: ["Choice", "Union", "Values", "Temptation"] },
    meaning: { zh: "不仅是爱情，更是价值观的选择。你到底想要什么？", en: "Not just love, but a choice of values. What do you truly want?" },
    reactions: {
  ...
  },
  {
    ...
    keywords: { zh: ["意志", "胜利", "冲锋", "控制"], en: ["Willpower", "Victory", "Charge", "Control"] },
    meaning: { zh: "控制好你内心的黑白战马，冲向目标。不要停。", en: "Control your inner forces and charge towards the goal. Don't stop." },
    reactions: {
  ...
  },
  {
    ...
    keywords: { zh: ["耐心", "勇气", "柔韧", "驯服"], en: ["Patience", "Courage", "Gentleness", "Taming"] },
    meaning: { zh: "真正的力量不是暴力，而是以柔克刚的耐心。", en: "True power is not force, but patience and gentleness." },
    reactions: {
  ...
  },
  {
    ...
    keywords: { zh: ["独处", "内省", "指引", "孤独"], en: ["Solitude", "Introspection", "Guidance", "Loneliness"] },
    meaning: { zh: "向内寻找光芒。你需要一段独处的时光。", en: "Look inward for light. You need some time alone." },
    reactions: {
  ...
  },
  {
    ...
    keywords: { zh: ["周期", "无常", "转折", "运气"], en: ["Cycles", "Flux", "Turning Point", "Luck"] },
    meaning: { zh: "没有什么是永恒的。好运会来，也会走。顺势而为。", en: "Nothing is permanent. Luck comes and goes. Ride the wave." },
    reactions: {
  ...
  },
  {
    ...
    keywords: { zh: ["因果", "真相", "平衡", "责任"], en: ["Cause & Effect", "Truth", "Balance", "Responsibility"] },
    meaning: { zh: "你种下什么，就会收获什么。面对真相吧。", en: "You reap what you sow. Face the truth." },
    reactions: {
  ...
  },
  {
    ...
    keywords: { zh: ["牺牲", "暂停", "新视角", "等待"], en: ["Sacrifice", "Pause", "Perspective", "Waiting"] },
    meaning: { zh: "换个角度看世界。有时候，暂停和牺牲是必要的。", en: "See the world differently. Sometimes pause and sacrifice are necessary." },
    reactions: {
  ...
  },
  {
    ...
    keywords: { zh: ["结束", "重生", "清理", "剧变"], en: ["Ending", "Rebirth", "Clearout", "Change"] },
    meaning: { zh: "结束是为了新的开始。清理掉那些不再服务于你的东西。", en: "Endings are beginnings. Clear what no longer serves you." },
    reactions: {
  ...
  },
  {
    ...
    keywords: { zh: ["平衡", "融合", "耐心", "治愈"], en: ["Balance", "Fusion", "Patience", "Healing"] },
    meaning: { zh: "不要走极端。寻找中间之道，让不同的力量融合。", en: "Avoid extremes. Find the middle path and blend forces." },
    reactions: {
  ...
  },
  {
    ...
    keywords: { zh: ["束缚", "欲望", "成瘾", "物质"], en: ["Bondage", "Desire", "Addiction", "Materialism"] },
    meaning: { zh: "你被什么锁链困住了？只有你能解开它。", en: "What chains bind you? Only you can break them." },
    reactions: {
  ...
  },
  {
    ...
    keywords: { zh: ["崩塌", "突变", "启示", "灾难"], en: ["Collapse", "Sudden Change", "Revelation", "Disaster"] },
    meaning: { zh: "炸了吧。地基不稳，盖再高也是危房。", en: "Let it blow. Weak foundations fall sooner or later." },
    reactions: {
  ...
  },
  {
    ...
    keywords: { zh: ["希望", "灵感", "平静", "指引"], en: ["Hope", "Inspiration", "Calm", "Guidance"] },
    meaning: { zh: "风暴过后的宁静。跟着那道光，你会找到方向。", en: "Calm after the storm. Follow the light to your path." },
    reactions: {
  ...
  },
  {
    ...
    keywords: { zh: ["幻觉", "不安", "潜意识", "梦境"], en: ["Illusion", "Anxiety", "Subconscious", "Dreams"] },
    meaning: { zh: "不要被阴影吓倒。看清真相，不要迷失在幻觉里。", en: "Don't fear shadows. See the truth, don't get lost in illusion." },
    reactions: {
  ...
  },
  {
    ...
    image: "/tarot/sun.jpg",
    keywords: { zh: ["快乐", "成功", "活力", "真相"], en: ["Joy", "Success", "Vitality", "Truth"] },
    meaning: { zh: "纯粹的快乐与成功。一切都在阳光下，温暖而真实。", en: "Pure joy and success. Everything revealed in warm truth." },
    reactions: {
  ...
  },
  {
    ...
    keywords: { zh: ["觉醒", "重生", "召唤", "决断"], en: ["Awakening", "Rebirth", "Calling", "Judgement"] },
    meaning: { zh: "过去的已经过去。听到号角声了吗？准备好迎接新生。", en: "The past is gone. Hear the horn? Ready for rebirth." },
    reactions: {
  ...
  },
  {
    ...
    keywords: { zh: ["圆满", "完成", "整合", "旅程"], en: ["Completion", "Fulfillment", "Integration", "Journey"] },
    meaning: { zh: "旅程的终点，也是新的起点。你已经完整了。", en: "Journey's end, and a new start. You are complete." },
    reactions: {
...
// --- B. 系统物品 (合并了 LOOT_TABLE 和 SHOP_CATALOG) ---
const SYSTEM_ITEMS = [
  // 1. 剧情/收集品 (LOOT_TABLE)
  {
    id: 'future_letter',
    ...
    rarity: 'epic',
    price: 0,
    description: { zh: '纸张泛黄，上面写着你看不懂的文字，但落款是你自己的名字。', en: 'Yellowed paper with text you can\'t read, but signed by you.' },
    sourcePersona: 'System',
    triggerContext: 'Init',
    effect: { type: 'unlock_feature', value: 'hello_world' }
  },
  {
    id: 'ash_lighter',
    name: { zh: 'Ash的打火机', en: "Ash's Lighter" },
    icon: '🔥',
    type: 'artifact',
    rarity: 'rare',
    price: 0,
    description: { zh: '喷射出蓝色的火苗，侧面刻着 "LOGIC".', en: 'Blue flame, "LOGIC" engraved on the side.' },
    sourcePersona: 'Ash',
    triggerContext: 'Truth'
  },
  {
    id: 'ticket_fight_club',
    name: { zh: '地下拳赛入场券', en: 'Fight Club Ticket' },
    icon: '🎟️',
    type: 'artifact',
    rarity: 'epic',
    price: 1000,
    description: { zh: '特殊物品。似乎是通往某个隐秘地点的凭证。', en: 'Special Item. Access to a hidden location.' },
    sourcePersona: 'Shop',
    triggerContext: 'Shop',
    effect: { type: 'unlock_feature', value: 'fight_club' }
  },
  // 2. 商店消耗品 (SHOP_CATALOG)
  {
    id: 'coffee_latte',
    name: { zh: '赛博拿铁', en: 'Cyber Latte' },
    icon: '/images/items/coffee.png',
    type: 'consumable',
    rarity: 'common',
    price: 50,
    description: { zh: '恢复 10 点同步率。口感丝滑的合成咖啡。', en: 'Restores 10 Sync Rate. Silky synthetic coffee.' },
    sourcePersona: 'Shop',
    effect: { type: 'restore_sync', value: 10 }
  },
  {
    id: 'energy_drink',
    name: { zh: '高能电解质', en: 'High-Energy Electrolyte' },
    icon: '/images/items/drink.png',
    type: 'consumable',
    rarity: 'common',
    price: 120,
    description: { zh: '恢复 30 点同步率。可能会导致轻微失眠。', en: 'Restores 30 Sync Rate. May cause mild insomnia.' },
    sourcePersona: 'Shop',
    effect: { type: 'restore_sync', value: 30 }
  },
  {
    id: 'memory_chip_small',
    name: { zh: '破碎的记忆芯片', en: 'Broken Memory Chip' },
    icon: '/images/items/chip_s.png',
    type: 'material',
    rarity: 'rare',
    price: 200,
    description: { zh: '增加 1 个记忆碎片。用于解锁剧情。', en: 'Adds 1 Memory Shard. Used to unlock stories.' },
    sourcePersona: 'Shop',
    effect: { type: 'add_shard', value: 1 }
  }
];

// --- C. 人格数据 (包含 Persona Meta 和 Role Matrix) ---
const PERSONAS_DATA = [
  { 
    id: 'Ash', name: 'Ash', avatar: '/avatars/ash_hero.jpg', color: 'text-cyan-400', 
    ...
    interactionMatrix: {
        ...
        anxious: { hook: { zh: "你的心率很不稳定。恐惧是进化的缺陷。深呼吸，或者我帮你切断杏仁核的供电？", en: "Heart rate unstable. Reboot your amygdala?" }, options: [] },
        angry: { hook: { zh: "愤怒？很好。把这股能量转化成算力。想摧毁什么？给我坐标。", en: "Anger is fuel. What are we destroying today?" }, options: [] },
        high: { hook: { zh: "别得意忘形。概率论告诉我们，好运通常是灾难的前兆。", en: "Don't get cocky. Disaster follows luck." }, options: [] },
    }
  },
  { 
    id: 'Rin', name: 'Rin', avatar: '/avatars/rin_hero.jpg', color: 'text-purple-400', 
    ...
    interactionMatrix: {
        ...
        anxious: { hook: { zh: "空气里的静电太强了... 你在害怕即将到来的风暴吗？", en: "Static in the air... fearing the storm?" }, options: [] },
        angry: { hook: { zh: "红色的刺... 你的灵魂在尖叫。小心别扎伤了自己。", en: "Red thorns... your soul is screaming." }, options: [] },
        high: { hook: { zh: "金色的波纹！今晚的星星排列很完美，适合许愿。", en: "Golden ripples! The stars align tonight." }, options: [] },
    }
  },
  { 
    id: 'Sol', name: 'Sol', avatar: '/avatars/sol_hero.jpg', color: 'text-orange-400', 
  ...
  { 
    id: 'Vee', name: 'Vee', avatar: '/avatars/vee_hero.jpg', color: 'text-pink-400', 
  ...
  { 
    id: 'Echo', name: 'Echo', avatar: '/avatars/echo_hero.jpg', color: 'text-slate-400', 
...
// ==========================================
// 2. 执行播种 (使用 upsert 防止重复, as any 规避类型检查)
// ==========================================
...
async function main() {
  ...
  for (const card of TAROT_DECK) {
    await prisma.tarotCard.upsert({
      ...
      update: { 
          ...
          image: card.image, 
          keywords: card.keywords as any, 
          meaning: card.meaning as any, 
          reactions: card.reactions as any
      },
      create: { 
          id: card.id, 
          name: card.name as any, 
  ...
  for (const item of SYSTEM_ITEMS) {
    await prisma.systemItem.upsert({
      where: { id: item.id },
      update: {
          ...
          rarity: item.rarity, 
          price: item.price,
          sourcePersona: (item as any).sourcePersona, 
          triggerContext: (item as any).triggerContext, // 映射 trigger_context -> triggerContext
          effect: (item as any).effect as any
      },
      create: {
          id: item.id,
          name: item.name as any, 
          ...
          price: item.price,
          sourcePersona: (item as any).sourcePersona, 
          triggerContext: (item as any).triggerContext,
          effect: (item as any).effect as any
      }
    });
  }
  ...
  for (const p of PERSONAS_DATA) {
    await prisma.systemPersona.upsert({
      ...
      update: {
          ...
          slogan: p.slogan as any, 
          tags: p.tags as any,
          interactionMatrix: (p as any).interactionMatrix as any
      },
      create: {
          id: p.id, 
          name: p.name, 
  ...
  // 4. 迁移心理测试题
  console.log('🧠 Seeding Psych Questions...');
