...
export const PERSONAS: Record<PersonaType, any> = {
  Ash: { name: "Ash", avatar: "/avatars/ash_hero.jpg", color: "text-blue-400", title: {zh:"批判者", en:"Critic"}, slogan: {zh:"别废话", en:"No BS"}, greetings: {zh:["说。"], en:["Speak."]}, prompts: {zh:"", en:""}, voiceConfig: {zh:{}, en:{}}, tags: { zh: ["毒舌", "真相"], en: ["Toxic", "Truth"] } },
  Rin: { name: "Rin", avatar: "/avatars/rin_hero.jpg", color: "text-pink-400", title: {zh:"分析师", en:"Analyst"}, slogan: {zh:"数据说话", en:"Data Only"}, greetings: {zh:["加载中..."], en:["Loading..."]}, prompts: {zh:"", en:""}, voiceConfig: {zh:{}, en:{}}, tags: { zh: ["冷静", "数据"], en: ["Calm", "Data"] } },
  Sol: { name: "Sol", avatar: "/avatars/sol_hero.jpg", color: "text-emerald-400", title: {zh:"发光体", en:"The Sun"}, slogan: {zh:"燃起来！", en:"Burn!"}, greetings: {zh:["嗨！"], en:["Hi!"]}, prompts: {zh:"", en:""}, voiceConfig: {zh:{}, en:{}}, tags: { zh: ["热情", "鸡血"], en: ["Hot", "Hype"] } },
  Vee: { name: "Vee", avatar: "/avatars/vee_hero.jpg", color: "text-purple-400", title: {zh:"黑客", en:"Hacker"}, slogan: {zh:"玩坏它", en:"Hack it"}, greetings: {zh:["嘿嘿"], en:["Hehe"]}, prompts: {zh:"", en:""}, voiceConfig: {zh:{}, en:{}}, tags: { zh: ["混乱", "乐子"], en: ["Chaos", "Fun"] } },
  Echo: { name: "Echo", avatar: "/avatars/echo_hero.jpg", color: "text-gray-400", title: {zh:"镜像", en:"Mirror"}, slogan: {zh:"我是你", en:"I am you"}, greetings: {zh:["..."], en:["..."]}, prompts: {zh:"", en:""}, voiceConfig: {zh:{}, en:{}}, tags: { zh: ["神秘", "回声"], en: ["Mystic", "Echo"] } },
};
...
export interface LootItem {
  id: string;
  name: { zh: string; en: string };
  iconSvg: string; // 我们直接把SVG代码存这，或者存路径
  description: { zh: string; en: string };
  sourcePersona: PersonaType;
}

// 核心掉落物列表 (SVG 路径假设在 /icons/ 下，稍后我会给你 SVG 代码)
